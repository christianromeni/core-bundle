...
abstract class Frontend extends \Controller
{
	...
	public static function getResponseFromCache()
	{
		...
		if (!empty($_POST) || \Input::cookie('FE_USER_AUTH') || \Input::cookie('FE_AUTO_LOGIN') || $_SESSION['DISABLE_CACHE'] || isset($_SESSION['LOGIN_ERROR']) || count(\System::getContainer()->get('session')->getFlashBag()->peekAll()) || \Config::get('debugMode'))
		{
			return null;
		}
